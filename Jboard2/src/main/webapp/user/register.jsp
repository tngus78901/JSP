...
<script src="/Jabord2/js/zipcode.js"></script>
<script src="/Jboard2/js/validation.js"></script>
<script src="/Jboard2/js/chekUser.js"></script>
                ...
                <form id="formUser" action="/Jboard2/user/register.do" method="post">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            <td>별명</td>
                            <td>
                                <p class="nickInfo">공백없이 한글, 영문, 숫자만 입력</p>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <button class="button" onclick="zipcode()"><img src="../img/chk_post.gif" alt="우편번호찾기"></button>
