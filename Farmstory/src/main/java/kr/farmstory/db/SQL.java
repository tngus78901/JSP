...
public class SQL {
		...
		public static final String SELECT_USER 			= "SELECT * FROM `User` WHERE `uid`=? AND `pass`=SHA2(2, 256)";
		public static final String SELECT_COUNT_UID 	= "SELECT * FROM `User` WHERE `uid`=?";
		...
		public final static String SELECT_LASTESTS = "SELECT `no`,`title`,`rdate` FROM `Article`"
		...
		public final static String SELECT_COMMENTS = "SELCT "
																							+ "a.*, "
																							+ "b.`nick` "
																							+ "FROM `Article` AS a "
																							+ "JOIN `User` AS b ON a.writer = b.uid "
