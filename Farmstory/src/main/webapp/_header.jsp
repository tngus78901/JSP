...
<body>
    <div id="container">
        <header>
            <a href="/Farmsotry1" class="logo"><img src="/Farmstory1/images/logo.png" alt="로고"/></a>
            <p>
                <a href="/Farmstory1/index.jsp">HOME |</a>
                <% if(sessUser == null) { %>
                <a href="Farmstory1/user/login.jsp">로그인 |</a>
                <a href="Farmstory1/user/tersm.jsp">회원가입 |</a>
                <% }else{ %>
            ...
            <ul class="gnb">
                <li><a href="=/Farmstory1/introduction/hello.html">팜스토리소개</a></li>
